...
const WhyDomainAuthorityMattersinLinkBuilding = () => {
  return (
    <>
              ...
              <div className="service_box style_two dark_color">
                <div className="image_boxes style_four">
                  <div className="image one">
                    <img
                      src="/images/service/why-domain-authority-matters-link-building.jpg"
                      className="img-fluid"
                      alt="about"
                    />
                  </div>
            ...
            <div className="col-xl-7 col-lg-6 col-md-12 col-sm-12 col-xs-12">
              <div className="title_all_box style_three  dark_color">
                <div className="title_sections three left">
                  <h2>Why Domain Authority Matters in Link Building</h2>
                  <p>
...
export default WhyDomainAuthorityMattersinLinkBuilding