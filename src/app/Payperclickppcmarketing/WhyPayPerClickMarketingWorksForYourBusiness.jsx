...
const WhyPayPerClickMarketingWorksForYourBusiness = () => {
    return (
        <>
                        ...
                        <div className="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                            <div className="service_box style_two dark_color">
                                <div className="image_boxes style_four">
                                    <div className="one">
                                        <img
                                            src="/images/service/why-pay-per-click-marketing.png"
                                            className="img-fluid"
                                            alt="about"
                                        />
                                    </div>
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div className="process_box style_one dark_color">
                                    <div className="process_box_outer">
                                        <div className="icon">
                                            <img
                                                src="/images/icons/low-barrier.png"
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div className="process_box style_one dark_color">
                                    <div className="process_box_outer">
                                        ...
                                        <div className="content_box">
                                            <h6>
                                                <a href="#">Improved Brand Visibility</a>
                                            </h6>
                                            <p>
                                                It is a long established fact that a reader will be
                                                distracted by the readable content of a page when looking at
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div className="process_box style_one dark_color">
                                    <div className="process_box_outer">
                                        <div className="icon">
                                            <img
                                                src="/images/icons/granular-targeting.png"
                                                className="img-fluid svg_image"
                                                alt="icon png"
                                            />
                                        </div>
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div className="process_box style_one dark_color">
                                    <div className="process_box_outer">
                                        <div className="icon">
                                            <img
                                                src="/images/icons/fast-results.png"
                                                className="img-fluid svg_image"
                                                alt="icon png"
                                            />
                                        </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box style_one dark_color">
                                <div className="process_box_outer">
                                    <div className="icon">
                                        <img
                                            src="/images/icons/quick-experimentation.png"
                                            className="img-fluid svg_image"
                                            alt="icon png"
                                        />
                                    </div>
                                    <div className="content_box">
                                        <h6>
                                            <a href="#">Quick Experimentation</a>
                                        </h6>
                                        <p>
                                            It is a long established fact that a reader will be distracted
                                            by the readable content of a page when looking at its layout.
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box style_one dark_color">
                                <div className="process_box_outer">
                                    ...
                                    <div className="content_box">
                                        <h6>
                                            <a href="#">One-time Campaign Promotions</a>
                                        </h6>
                                        <p>
                                            It is a long established fact that a reader will be distracted
                                            by the readable content of a page when looking at its layout.
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box style_one dark_color">
                                <div className="process_box_outer">
                                    ...
                                    <div className="content_box">
                                        <h6>
                                            <a href="#">Immediate and Consistent Traffic</a>
                                        </h6>
                                        <p>
                                            It is a long established fact that a reader will be distracted
                                            by the readable content of a page when looking at its layout.
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box style_one dark_color">
                                <div className="process_box_outer">
                                    <div className="icon">
                                        <img
                                            src="/images/icons/expansive-traction-channels.png"
                                            className="img-fluid svg_image"
                                            alt="icon png"
                                        />
                                    </div>
                                    <div className="content_box">
                                        <h6>
                                            <a href="#">Expansive Traction Channels</a>
                                        </h6>
                                        <p>
                                            It is a long established fact that a reader will be distracted
                                            by the readable content of a page when looking at its layout.
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box style_one dark_color">
                                <div className="process_box_outer">
                                    <div className="icon">
                                        <img
                                            src="/images/icons/expansive-traction.png"
                                            className="img-fluid svg_image"
                                            alt="icon png"
                                        />
                                    </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box style_one dark_color">
                                <div className="process_box_outer">
                                    <div className="icon">
                                        <img
                                            src="/images/icons/total-customization.png"
                                            className="img-fluid svg_image"
                                            alt="icon png"
                                        />
                                    </div>
...
export default WhyPayPerClickMarketingWorksForYourBusiness