                        ...
                        <div className="col-lg-12">
                            <div className="title_all_box style_one text-center dark_color">
                                <div className="title_sections">
                                    ...
                                    {/* removed lineHeight = 28 from h4 style property */}
                                    <h4 style={{ color: "#576c2c", fontSize: 20}}>
                                        Partner with Shopify SEO Experts and Enhance Your Brand Credibility
                                    </h4>
                                    <p>
                                        ...
                                        in the United States. We provide data-driven SEO solutions to businesses of all types and sizes. Our online marketing services are designed to improve SEO on Shopify.
                                    </p>
