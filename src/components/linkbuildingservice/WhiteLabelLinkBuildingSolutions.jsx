...
const WhiteLabelLinkBuildingSolutions = () => {
  return (
    <>
            ...
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
              <div className="service_box style_two dark_color">
                <div className="image_boxes style_four">
                  <div className="one">
                    <img
                      src="/images/service/link-building-solutions.jpg"
                      className="img-fluid"
                      alt="about"
                    />
                  </div>
                          ...
                          <li className="list_items pd_bottom_10">
                            <small className="d-flex align-items-center">
                              ...
                              <a
                                ...
                                rel='"nofollow"'
                              >
                                Enhance your mobile marketing efforts{" "}
                              </a>
                            </small>
                          </li>
                        </ul>
...
export default WhiteLabelLinkBuildingSolutions