...
const TheBestLinkBuildingServiceForYourBusiness = () => {
  return (
    <>
              ...
              <div className="col-lg-10">
                <div className="title_all_box style_one text-center dark_color">
                  <div className="title_sections">
                    <h3>The Best Link Building Service For Your Business</h3>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div className="image one">
                  <img
                    src="/images/service/best-link-building-service.jpg"
...
export default TheBestLinkBuildingServiceForYourBusiness