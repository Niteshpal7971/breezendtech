...
const MaketheRightDecisionsforYourBrandWithPPCAdvertising = () => {
    return (
        <>
                            ...
                            <div className="service_box style_two dark_color">
                                <div className="image_boxes style_four">
                                    <div className="image one pd_bottom_25">
                                        <img
                                            src="/images/service/pay-per-click-marketing.jpg"
                                            className="img-fluid"
                                            alt="about"
                                        />
...
export default MaketheRightDecisionsforYourBrandWithPPCAdvertising