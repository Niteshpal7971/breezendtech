...
const PremiumeCommerceProductPhotographyPackages = () => {
    return (
        <>
                        ...
                        <div className="col-lg-12">
                            <div className="title_all_box style_one text-center dark_color">
                                <div className="title_sections">
                                    <h2>Premium eCommerce Product Photography Packages</h2>
                                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <div className="packages-primium-header">
                                <dl className="">
                                    <dt className="faq_header active">SINGLE PRODUCT LAUNCH</dt>
...
export default PremiumeCommerceProductPhotographyPackages